...
--   3. python manage.py sqlmigrate shownews 0001 > database_sql_commands.txt
--
...
--
CREATE TABLE "shownews_newsdata" ("id" serial NOT NULL PRIMARY KEY, "title" text NOT NULL, "url" varchar(200) NOT NULL UNIQUE, "time" timestamp with time zone NOT NULL, "read_time" timestamp with time zone NULL, "creation_time" timestamp with time zone NOT NULL, "last_modified_time" timestamp with time zone NOT NULL);
--
